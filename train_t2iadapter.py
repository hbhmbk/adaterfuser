...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default='/x22201004/pretrained_model/model.safetensors',
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/x22201004/t2iadapter-model",
...
def main(args):
    ...
    t2iadapter_fuser=T2IAdapter(channels=[320, 640, 1280,1280], in_channels=3,downscale_factor=16,adapter_type="full_adapter_xl")
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(t2iadapter_fuser):
                ...
                down_block_additional_residuals = t2iadapter_fuser(batch['conds']['scribble'])
