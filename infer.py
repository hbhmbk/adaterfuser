...
state_dict = load_file("/x22201004/checkpoint-144000/model.safetensors")
...
test_dataset=dataset_laion(path='/x22201004/testimg1',pkl="/x22201004/pexels.pkl",bs=1,drop_cond_rate=0.0)
...
for data in test_dataloader:
    ...
    gen_images.save('/x22201004/testimg1/img/{}.jpg'.format(i))
    # output_path=os.path.join('/x22201004/multi_cond/caption','{}.txt'.format(i))
    ...
    #     img.save('/x22201004/multi_cond/cond/{}_{}'.format(i,name)+'.jpg')
